// run-prolabs-v1-sfp.js
// ProLabs V1 SFP — clones EO E000270779
// Usage: node "Bulk EO Creation/run-prolabs-v1-sfp.js"
...
async function main() {
  ...
  const child = spawn('npx', ['playwright', 'test', 'prolabs-v1-sfp.spec.ts', '--headed', '--project=chromium'], {
    env,
    stdio: 'inherit',
    shell: true,
