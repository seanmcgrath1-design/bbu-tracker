// run-Ericsson V2 SFP.js
// Ericsson V2 SFP — clones EO E000239551
// Usage: node "Bulk EO Creation/run-Ericsson V2 SFP.js"
...
async function main() {
  ...
  const child = spawn('npx', ['playwright', 'test', 'Ericsson V2 SFP.spec.ts', '--headed', '--project=chromium'], {
    env,
    stdio: 'inherit',
    shell: true,
